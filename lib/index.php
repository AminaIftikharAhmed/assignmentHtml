<?php 
	require_once("../lib/php/component.php");
    require_once("../lib/php/operation.php");
...
<body>
	...
	<main>
		<div class="container text-center">
			<h1 class="py-4 bg-dark text-light rounded"><i class="fas fa-swatchbook"></i> Online Library
			</h1>
